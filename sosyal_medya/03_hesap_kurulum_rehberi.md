...
| Kuruluş | 1986 |
| Profil görseli | `gonderiler/marka/profil_1080.png` (lacivert) – açık zemin isteyen yerlerde `profil_acik_1080.png` |

## Instagram (İşletme hesabı)

- **Ad alanı (SEO aranabilir):** `Yamansa Rulman | Rulman Tedarik`
- **Bio (150 karakter):**
  ```
  Rulman ithalat & distribütörlük • 1986
  SKF · FAG · ORS · NMB · TPI
...
- **Kullanıcı adı:** @yamansarulman
- **Kapak:** `gonderiler/marka/facebook_kapak_1640x624.png`
- **Hakkında (kısa):** `Rulman ithalat ve distribütörlüğü. 1986'dan beri İkitelli OSB'den tüm Türkiye'ye; motosiklet, scooter ve sanayi rulmanları stoktan aynı gün kargo.`
- **Hakkında (uzun / SEO):**
  ```
  Yamansa Rulman İthalat San. ve Dış Tic. Ltd. Şti., 1986'dan bu yana İstanbul İkitelli OSB'de rulman ithalatı ve
  distribütörlüğü yapmaktadır. SKF, FAG, ORS, NMB ve TPI markalarının yetkili distribütörü olarak sabit bilyalı
...
- **Slogan (120 kr.):** `Rulman ithalat & distribütörlük • SKF · FAG · ORS · NMB · TPI • 1986'dan beri İstanbul`
- **Kapak:** `gonderiler/marka/linkedin_kapak_2256x382.png`
- **Sektör:** Endüstriyel Makine Üretimi / Toptan Ticaret · **Şirket büyüklüğü:** 11-50 · **Tür:** Özel şirket · **Kuruluş:** 1986
- **Uzmanlık alanları:** Rulman, Sabit Bilyalı Rulman, Konik Makaralı Rulman, Silindirik Makaralı Rulman, Motosiklet Rulmanı, Scooter Rulmanı, Rulman İthalatı, B2B Tedarik
- **Hakkında:** Facebook uzun metninin LinkedIn tonunda hali (emoji yok, "biz" dili, bayi/B2B vurgusu).
- Buton: **Web Sitesini Ziyaret Et**.

## SEO / otorite için ek adımlar (önerilen)

1. **Google İşletme Profili** aç (aynı NAP, aynı kategori, aynı fotoğraflar). Yerel arama ("rulman ikitelli") için en etkili tek adım.
...
4. Her gönderi metninde hedef anahtar kelime **doğal olarak ilk cümlede** geçer (IG/FB aramasında ve Google'ın sosyal içerik indekslemesinde etkili).
5. Aylık: UTM raporu (GA4 → Kazanım → Trafik kaynağı) ile hangi tema trafik getirdi → sonraki ay ağırlığı artır.

## Hesap açılışı için gereken bilgiler
